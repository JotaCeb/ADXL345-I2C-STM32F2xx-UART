...
#define ADXL345_DATARATE_3200_HZ    ((uint8_t)0x0F) 	// 1600Hz Bandwidth   140µA IDD
#define ADXL345_DATARATE_1600_HZ    ((uint8_t)0x0E) 	//  800Hz Bandwidth    90µA IDD
#define ADXL345_DATARATE_800_HZ     ((uint8_t)0x0D)		//  400Hz Bandwidth   140µA IDD
#define ADXL345_DATARATE_400_HZ     ((uint8_t)0x0C) 	//  200Hz Bandwidth   140µA IDD
#define ADXL345_DATARATE_200_HZ     ((uint8_t)0x0B) 	//  100Hz Bandwidth   140µA IDD
#define ADXL345_DATARATE_100_HZ     ((uint8_t)0x0A) 	//   50Hz Bandwidth   140µA IDD
#define ADXL345_DATARATE_50_HZ      ((uint8_t)0x09) 	//   25Hz Bandwidth    90µA IDD
#define ADXL345_DATARATE_25_HZ      ((uint8_t)0x08) 	// 12.5Hz Bandwidth    60µA IDD
#define ADXL345_DATARATE_12_5_HZ    ((uint8_t)0x07) 	// 6.25Hz Bandwidth    50µA IDD
#define ADXL345_DATARATE_6_25HZ     ((uint8_t)0x06) 	// 3.13Hz Bandwidth    45µA IDD
#define ADXL345_DATARATE_3_13_HZ    ((uint8_t)0x05) 	// 1.56Hz Bandwidth    40µA IDD
#define ADXL345_DATARATE_1_56_HZ    ((uint8_t)0x04) 	// 0.78Hz Bandwidth    34µA IDD
#define ADXL345_DATARATE_0_78_HZ    ((uint8_t)0x03) 	// 0.39Hz Bandwidth    23µA IDD
#define ADXL345_DATARATE_0_39_HZ    ((uint8_t)0x02) 	// 0.20Hz Bandwidth    23µA IDD
#define ADXL345_DATARATE_0_20_HZ    ((uint8_t)0x01) 	// 0.10Hz Bandwidth    23µA IDD
#define ADXL345_DATARATE_0_10_HZ    ((uint8_t)0x00)  	// 0.05Hz Bandwidth    23µA IDD (default value)
